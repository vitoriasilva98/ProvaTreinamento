...
<%@ page import = "br.com.prova.persistence.*" %>
<%@ page import = "br.com.prova.controller.*" %>
<%@ page import = "br.com.prova.entity.*" %>
		...
		<div class="container mt-5">
			<table class="table table-bordered table-striped table-hover">
				...
				%>
					<tr>
						<td><%out.print(i+1);%></td>
						<td><%out.print(gabarito.get(i).getAcerto());%></td>
						<td><%out.print(gabarito.get(i).getAlternativaEscolhida());%></td>
						<td><%out.print(alternativaCorreta.get(i).getAlternativaCorreta());%></td>
					</tr>
					<% } %>
				</tbody>
			</table>
